        ...
        <Wrapper>
          <div className="h-[1422px] flex flex-col gap-[130px] items-center">
            <section className="w-[1078px] h-[547px] flex justify-between items-center">
              <img className="select-none" draggable={false} src="src/assets/images/about/idea-and-woman.png" alt="Девушка сидит на камне" />
            ...
            <section className="w-full h-[547px] flex justify-between items-center">
              ...
              <img className="select-none" draggable={false} src="src/assets/images/about/magic-in-details.png" alt="Девушка в белом платье" />
            </section>
            <a href="/shop">
